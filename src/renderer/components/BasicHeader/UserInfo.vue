            ...
            >
                    ...
                    <a-spin :spinning="loadding">
                        <div class="user-box">
                            ...
                            >
                                <a-col>
                                    ...
                                    >
                                        <img
                                            v-lazy="
                                                `${userInfo.profile.avatarUrl}?param=50y50`
                                            "
                                            class="user-avatar"
                                        />
                            ...
                            >
                                <a-col :span="6">
                                    <router-link
                                        :to="`/user-event?uid=${userInfo.userId}&nickname=${userInfo.profile.nickname}`"
                                        class="list2-item"
                                    >
                                        <strong>{{
                ...
                <span class="header-user">
                    ...
                    <span
                        ...
                        :key="userInfo.profile.nickname"
                        :title="userInfo.profile.nickname"
                    >
                        <span class="header-user-info-name">{{
                            userInfo.profile.nickname
                        }}</span>
                        <img
                            src="./../../assets/images/vip.jpg"
...
export default {
    ...
    methods: {
        ...
        async refreshData(visible) {
            if (visible) {
                this.loadding = true;
                let [err, detail] = await this.$errorCaptured(
